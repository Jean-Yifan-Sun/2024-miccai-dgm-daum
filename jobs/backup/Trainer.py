    ...
    def train(self, model_state=None, opt_state=None, accountant=None, start_epoch=0):
        ...
        for epoch in range(self.training_params['nr_epochs']):
            ...
            for idx, data in enumerate(self.train_ds):
                ...
                # logging.info(f'labels_pred: {labels_pred}, labels: {labels}')
            ...
            if epoch % 10 == 0 and epoch != 0:
                _dict = torch.load(self.client_path + '/latest_model.pt')
                self.test(self.model.module.state_dict(), self.val_ds, 'Val', self.optimizer.state_dict(), epoch)
