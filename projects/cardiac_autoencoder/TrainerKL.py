...
from optim.losses.vae_losses import KLDLoss
...
class PTrainer(Trainer):
    ...
    def train(self, model_state=None, opt_state=None, accountant=None, start_epoch=0):
        ...
        self.criterion_kld = KLDLoss(gamma=self.training_params['kld_gamma'], max_capacity=3)
        ...
        for epoch in range(self.training_params['nr_epochs']):
            if start_epoch > epoch:
                continue
            start_time = time()
            (batch_loss, batch_loss_rec, batch_loss_kld,
            ...
            for idx, data in enumerate(self.train_ds):
                ...
                loss_kld = self.criterion_kld(dist).mean()
                ...
                loss = loss_rec + loss_kld + loss_adv + loss_pl
                loss.backward()
                ...
                batch_loss_kld += loss_kld.item() * images.size(0)
            ...
            self.log_to_wandb({"Train/Loss_": epoch_loss,
                       ...
                       "Train/Loss_kld_": batch_loss_kld / count_images,
